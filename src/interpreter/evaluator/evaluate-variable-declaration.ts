 ...
 */
export function evaluateVariableDeclaration ({node, environment, evaluate, stack, typescript, statementTraversalStack}: IEvaluatorOptions<TS.VariableDeclaration>, initializer?: Literal): void {
